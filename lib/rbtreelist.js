...
Node.prototype.setChild = function (dir, node) {
    ...
    // If the current link references this node as the parent,
    // break the link
    if (this[link] && this[link].parent === this) {
        this[link].parent = null;
    }

    // Set the new parent/child link
    this[link] = node;

    // Set the child's new parent
    if (! this.isHead && node !== null) {
        node.parent = this;
    }
...
Node.prototype.setSibling = function (dir, node) {
