...
TreeBase.prototype.findAtIndex = function (searchIndex) {
    var node = this._root;
...
TreeBase.prototype.getIndex = function (data) {
    var node = this._root;
    var index = 0;
    var c, dir;
...
TreeBase.prototype.print = function () {
    var coords = {};
    var graph = '';
